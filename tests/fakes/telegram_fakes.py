...
class FakeUpdate:
    ...
    def __init__(self, chat_id=None, username=None, text=None):
        ...
        self.message = FakeMessage(chat_id=chat_id, text=text, user=FakeUser(username=username))
...
class FakeBot:
    ...
    async def send_message(self, chat_id=None, text=None, parse_mode=None, reply_markup=None, disable_web_page_preview=None):
...
def create_fake_notification(notification_id, chat_id, grant_title, grant_url=None, start_date=None, end_date=None):
